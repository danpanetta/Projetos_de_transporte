...
arquivo_shape_centroides = '/Users/danilopanettadefaria/Documentos/Projects/TGT410062/Trabalho/novo/dados/originais/centroides_teste.shp'
arquivo_temporario = '/Users/danilopanettadefaria/Documentos/Projects/TGT410062/Trabalho/novo/dados/processados/temp.csv'
arquivo_shape_edges = '/Users/danilopanettadefaria/Documentos/Projects/TGT410062/Trabalho/novo/dados/processados/shapefile/edges.shp'
...
# ===================================================================================================================================            
            ...
            executa("shp2pgsql -S \"%s\" centroides | psql -U danilo -d trabalho" % arquivo_shape_centroides) # -S é para fprçar que não venha geometria multiplas que pode atrapalhar
            #executa("ogr2ogr -f \"PostgreSQL\" PG:\"%s\" \"%s\"" % (db_string, arquivo_shape_centroides)) # (para o windows) 

            cur.execute("DROP TABLE IF EXISTS edges")
            executa("shp2pgsql -S \"%s\" edges | psql -U danilo -d trabalho" % arquivo_shape_edges) # -S é para fprçar que não venha geometria multiplas que pode atrapalhar
